...
$_SESSION["user_name"] = $admin_name; // Assuming $admin_name from fetched admin data

// Prepare query
$stmt = $conn->prepare("SELECT Full_Name, Email, Admin_ID FROM Admin WHERE User_Name = ?");
if ($stmt === false) {
...
<body>
    <header>
        ...
        <div class="profile">
            ...
            <a href="edit_profile.php?user=<?php echo urlencode($admin_name); ?>">
    ...
    <main>
        ...
        <p>Admin ID: <?php echo htmlspecialchars($admin_data['Admin_ID']); ?></p>
        <p>Email: <?php echo htmlspecialchars($admin_data['Email']); ?></p>
        <div class="button-container">
        <button onclick="location.href='/htp2/adoption_admin.php'">Adoption Requests &gt;</button>
        <button onclick="location.href='/htp2/rehome_admin.php'">Rehome Requests &gt;</button>
        </div>
    </main>
