...
$email_query = "SELECT Email FROM admin WHERE User_Name = ?";
...
<head>
    ...
    <script>
        ...
        function refreshSession() {
            ...
            xhr.open("POST", "/CSE311 Project - Huts for Paws/session_refresh.php", true); // Endpoint to refresh session
            xhr.onload = function () {
                if (xhr.status === 200) {
...
<body>
    ...
    <script>
        ...
        function checkSession() {
            var xhr = new XMLHttpRequest();
            xhr.open("GET", "/CSE311 Project - Huts for Paws/session_check.php", true);
            xhr.onload = function () {
                if (xhr.status === 200 && xhr.responseText !== "logged_in") {
                    window.location.href = "/CSE311 Project - Huts for Paws/login.php";
                }
            };
            xhr.send();
        }
